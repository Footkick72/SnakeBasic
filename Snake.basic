10 LET width = 38
20 LET height = 22
30 DIM snake(width*height, 2), collision(width, height)
...
1020 LET keystroke = peek(-16384) - 128 + 32
...
1140 sEnd = sEnd - 1
1150 IF sEnd == -1 THEN sEnd = (width*height)-1

1160 COLOR=0: VLIN 2*snake(sEnd,1), 2*snake(sEnd,1)+1 AT snake(sEnd,0)
1170 collision(snake(sEnd,0), snake(sEnd,1)) = 0

1180 IF collision(XPlayer, YPlayer) == 1 GOTO 2000
...
1260 collision(XPlayer, YPlayer) = 1
